...
const VideoSection = () => {
    return (
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="relative z-10 p-3 bg-white/90 backdrop-blur-lg rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.3)] border border-white">
                <div className="relative w-full overflow-hidden rounded-xl">
                <video 
                    className="w-full h-auto"
                    src="/intern-backend-new-vid.mp4"
                    controls
                    preload="auto"
                    poster="/redssaa.png"
                >
                ...
                <div className="mt-4 p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-indigo-100/50">
