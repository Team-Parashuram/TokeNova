  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-lg font-medium text-gray-700">Loading your tickets...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-6">
        ...
        >
          ...
          <p className="text-gray-600 mt-2 max-w-md">You don't have any tickets yet. Browse events and secure your spot!</p>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="relative mb-8">
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-3xl font-bold text-gray-800 z-10 relative">My Tickets</h1>
        </motion.div>
      </div>
            ...
            <div className="p-8 flex flex-col md:flex-row md:items-center md:justify-between relative">
              <div className="flex-1">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-800 group-hover:text-indigo-700 transition-colors">{ticket.eventName}</h2>
                    
                    <div className="mt-3 flex flex-wrap gap-5">
                      <div className="flex items-center text-base text-gray-600">
                        <Calendar size={16} className="mr-2" />
                        {new Date(ticket.eventDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                      </div>
                      <div className="flex items-center text-base text-gray-600">
